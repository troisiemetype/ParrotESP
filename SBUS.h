 ...
 *
 *  Notes :
 *      frame are transmitted every 10 to 20ms. It seems that Minidrones don't like update bellows 20-25ms, so frame rate could be lowered.
 ...
 *      full range for servos (0-2047, 11 bits) correspond to extended limits range, -150% - 150% (to be sonfirmed by testing)
 */
